<template>
	<section id="rank-edit" class="poeui-page">
		<header class="poeui-content-header flex-row flex-line-center" >
			...
			<div>
				<button class="btn-block primary dp-block" style="width:1rem" :disabled="!changed" @click="handlePost">提交</button>
			</div>
		</header>
		...
		<article class="poeui-content-box" style="min-width: 9rem;">
			...
			<button class="btn-block btn-large btn-round primary dp-block ma-20" style="width:2rem" :disabled="!changed" @click="handlePost">提交</button>
		</article>
	</section>
